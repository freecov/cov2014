<?php
  ...
  */
  ...
  if(!class_exists('Voip_AsteriskManager'))
  {
    require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'asteriskmanager.php');
  }
  ...
  */
  class Voip_agi
  {
    ...
    */
    ...
    {
      $this->asm = new Voip_AsteriskManager(NULL, $this->config);
      $this->asm->pagi =& $this;
