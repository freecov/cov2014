...
*/
	...
	$view->addMapping(gettext("telephone/mobile/skype"), "%%complex_phone");
	...
	if ($achange) {
		$view->defineComplexMapping("complex_actions", array(
			...
			array(
				...
				"src"     => "edit",
				"alt"     => gettext("edit"),
				"link"    => array("javascript: bcard_edit(", "%id", ", ", "%address_id", ");"),
				"check" => "%rcbc"
			),
			array(
				"type"    => "action",
	...
	$view->defineComplexMapping("complex_phone", array(
		...
		array(
			"type"    => "action",
			"src"     => "data_business_skype",
			"alt"     => gettext("business skype"),
			"check"   => "%business_skype"
		),
		array(
			"type"   => "link",
			"text"   => array(
			...
			"link"   => array("callto:", "%business_skype"),
			"target" => "_blank",
			"check" => "%business_skype"
		)
		,
		array(
			"type"    => "action",
			"src"     => "data_private_skype",
			"alt"     => gettext("private skype"),
			"check"   => "%personal_skype"
		),
		array(
			"type"   => "link",
			"text"   => array(
			...
			"link"   => array("callto:", "%personal_skype"),
			"target" => "_blank",
			"check" => "%personal_skype"
		)
	));
	...
	$view->setHtmlField("business_skype");
	$view->setHtmlField("business_skype");
