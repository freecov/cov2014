...
function cmsEdit(id) {
	popup('/?mod=cms&syncweb=1&action=editpage&id='+id, 'cmseditor', 990, 750, 1);
}
function cmsLoginPage(uri) {
	popup('/mode/covidelogin&uri='+uri, 'cmslogin', 600, 500, 1);
}
...
function openGalleryItem(id, descr) {
	var galleryitem = popup('/showcms.php?html=1&size=medium&galleryid='+id+'&description='+descr, 'galleryitem', 320, 300, 1);
}
...
function load_abbr(n) {
	return document.getElementById('tt_abbr_' + n).innerHTML;
}
