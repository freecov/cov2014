<?php
	...
	function changePrijs2(){ ?>
			...
			<?php venster_header("facturen", "bedrag wijzigen - product", array(), 0, -1); ?>
...
<?php	}
	...
	function changePrijs(){ ?>
			...
			<?php venster_header("facturen", "bedrag wijzigen", array(), 0, -1); ?>
					<tr><td background="img_td_titel_bg.gif" colspan="15" height="1">
...
<?php	}
	...
	function offertesOverzicht() {
		...
		?>
			...
			<?php venster_header("facturen", "", $menu, 0, -1); ?>
						...
						<tr><td colspan="2" align="center" <?php echo td(1) ?> ><nobr>
						...
						</span></td><td colspan="7" <?php echo td(1) ?>><table border="0" cellspacing="0" cellpadding="0">
								<?php //zoeken ?>
										<tr><td align="right"><span class="d"><nobr>zoeken op tekst:&nbsp;</nobr></td><td><input type="text" class="inputtext" name="zoeken" value="<?php echo ($zoeken) ?>" style="width:200px;">&nbsp;<a href="Javascript: setWaarde('klanten', ''); setWaarde('maand', ''); setWaarde('jaar', ''); verzend();"><img src="../img/knop_rechts.gif" border="0"></a></td></tr>
										<tr><td height="4"></td></tr>
										<tr><td align="right"><span class="d"><nobr>of zoeken op debiteur:&nbsp;</nobr></td><td><nobr>
										...
										<tr><td height="4"></td></tr>
										<tr><td align="right"><span class="d"><nobr>of zoeken op datum:&nbsp;</nobr></td><td>
						...
						<tr>
							...
							<td <?php echo td(0) ?> height="21"><a href="Javascript:setWaarde('sort','datum');verzend();"><img src="../img/knop_sort.gif" align="right" border="0"></a>&nbsp;datum</td>
								...
								<?php for ($j=0;$j<count($statusOmschrijving);$j++){ ?>
									<?php if ($statusOmschrijving[$j] == "offerte") { continue; } ?>
						...
						<?php } ?>
							...
							<?php for ($j=0;$j<count($statusOmschrijving);$j++){ ?>
								<?php if ($statusOmschrijving[$j] == "offerte") { continue; } ?>
								<td <?php echo td(1) ?> align="left"><nobr>&nbsp;
								<?php
									/*
							...
							<td <?php echo td(1) ?> width="53"><nobr>
								<?php
						...
						<?php if ($overzicht != "" && $totaal != ""){ ?>
							<tr><td colspan="4"></td><td colspan="10" <?php echo td(2) ?>><nobr>&nbsp;&euro; <?php echo $totaal; ?></nobr></td></tr>
						<?php } ?>
				<?php tabel_footer(); ?>
			...
			<?php
				...
				#echo $email->emailSelectFromPrepare();
			?>
<?php }
	...
	function offertesInvoeren(){
			...
			<?php venster_header("facturen", $titelp." (".$statusOmschrijving[$status].")", $menu, 0, -1); ?>
				<tr>
...
<?php }
	...
	function offertesVerwijder(){ ?>
			...
			<?php venster_header("facturen", "verwijder", array(), 0, -1); ?>
					<tr><td background="img_td_titel_bg.gif" colspan="15" height="1"><table border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td><span class="dT">Hiermee wordt de factuur verwijderd. Vergeet hierna niet de oplopende factuurnummering te herstellen.<br><br>Weet u het zeker?</span></td></tr></table></td></tr>
