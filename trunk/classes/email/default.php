...
Class Email {
	...
	public function __construct() {
		...
		switch ($_REQUEST["action"]) {
			...
			case "set_star":
				$emailData = new Email_data();
				$emailData->set_star($_REQUEST["mail_id"]);
				$email = new Email_output();
				$email->emailList();
				break;
			case "viewStarredMail":
				$_REQUEST["starview"] = 1;
				$email = new Email_output();
				$email->emailList();
				break;
			case "toggle_private_state":
				$emailData = new Email_data();
				$emailData->toggle_private_state($_REQUEST['mail_id']);
				$email = new Email_output();
				$email->emailList();
				break;
			...
			case "change_project_xml":
				...
				break;
			case "delete_project_xml":
				$email = new Email_data();
				$email->delete_project_xml();
				break;
