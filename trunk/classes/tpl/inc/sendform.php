					...
					foreach ($fields as $key=>$val) {
						if ($key == "companyname") {
							...
							if ($address_type == "relations") {
								...
								$address_record["private_zipcode"] = $req["data"][$v["field_name"]][$key];
							}
						} elseif ($key == "city") {
							if ($address_type == "relations") {
								$address_record["city"] = $req["data"][$v["field_name"]][$key];
							} else {
								$address_record["private_city"] = $req["data"][$v["field_name"]][$key];
							}
						} elseif ($key == "country") {
							...
							if ($address_type == "relations") {
								...
								$address_record["business_phone_nr"] = $req["data"][$v["field_name"]][$key];
							}
						} elseif ($key == "fax_nr") {
							if ($address_type == "relations") {
								$address_record["fax_nr"] = $req["data"][$v["field_name"]][$key];
							} else {
								$address_record["private_fax_nr"] = $req["data"][$v["field_name"]][$key];
							}
						} elseif ($key == "email") {
							...
							if ($address_type == "relations") {
								...
								$address_record["private_email"] = $req["data"][$v["field_name"]][$key];
							}
						} elseif ($key == "birthday") {
