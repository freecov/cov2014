...
$venster->addVensterData();
	...
	$view->addMapping(gettext("business address"), array("%business_address","\n","%business_address2"));
	$view->addMapping(gettext("business zip code"), "%business_zipcode");
	$view->addMapping(gettext("business city"), "%business_city");
	$view->addMapping(gettext("private address"), array("%personal_address","\n","%personal_address2"));
	$view->addMapping(gettext("private zip code"), "%personal_zipcode");
	$view->addMapping(gettext("private city"), "%personal_city");
