...
/**
  ...
  */
	...
	//XXX: Please document where we use what program. That way we can easily get rid of it
	$check = array(
	...
	/**
	 * By default, the OpenBSD httpd runs chrooted.
	 * This means we dont have any of the above commands available.
	 *
	 * While covide runs ok without them, some parts wont actually work.
	 * For my laptop it's ok, and since we dont support OpenBSD for running Covide
	 * officially, I think it's fine to disable the binary check for now.
	 *
	 * IF YOU RUN COVIDE ON OPENBSD, YOU'RE ON YOUR OWN. THIS IS NOT SUPPORTED
	 * AND THINGS _WILL_ BREAK
	 */
	if (PHP_OS == "OpenBSD") {
		$check = array();
	}
