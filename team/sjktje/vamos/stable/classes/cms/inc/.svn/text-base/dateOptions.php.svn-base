	...
	$venster->addVensterData();
		...
		$tbl->addTableRow();
			$tbl->addTableData(array("colspan"=>2), "data");
				...
				$view->addMapping( gettext("from"), "%username" );
				$view->addMapping( gettext("till"), "%is_enabled_h" );
				$view->addMapping( gettext("repeating"), "%is_enabled_h" );
				$view->addMapping( gettext("description"), "%is_enabled_h" );
		...
		$venster->insertAction("new", gettext("new item"), "javascript: popup('?mod=cms&action=dateOptionsItemEdit', 'settings', 640, 480, 1);");
