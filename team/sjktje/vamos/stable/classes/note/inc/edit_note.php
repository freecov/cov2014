...
$venster->addVensterData();
	...
	$table->addTableRow();
		$table->insertTableData(gettext("customercontact"), "", "header");
		$table->addTableData("", "data");
			$table->addCheckBox("note[is_support]", 1, $note["is_support"]);
		$table->endTableData();
	$table->endTableRow();
	$table->addTableRow();
		$table->insertTableData(gettext("create todo"), "", "header");
		$table->addTableData("", "data");
	...
	if ($GLOBALS["covide"]->license["has_sales"]) {
		$table->addTableRow();
			$table->insertTableData(gettext("create salesitem"), "", "header");
			$table->addTableData("", "data");
	...
	if ($sms) {
		$table->addTableRow();
			$table->insertTableData(gettext("send as sms to user"), "", "header");
			$table->addTableData("", "data");
