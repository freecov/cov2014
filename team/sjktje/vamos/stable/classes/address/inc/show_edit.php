...
$venster->addVensterData();
	...
	$table->addTableRow();
		...
		$table->addTableData("", "data");
			...
			$table->addSpace(1);
			$table->addCode(gettext("zip code po box"));
			$table->addSpace(1);
			$table->addTextField("address[pobox_zipcode]", $address_info["pobox_zipcode"]);
			$table->addSpace(1);
			$table->addCode(gettext("city po box"));
			$table->addSpace(1);
	...
	$table->addTableRow();
		...
		$table->addTableData("", "data");
			...
			$table->addSpace(1);
			$table->addCode(gettext("mobile phone nr"));
			$table->addSpace(1);
			...
			$table->addTableRow();
				...
				$table->addTableData("", "data");
					if ($address_info["photo"]["size"]) {
						...
						$table->insertAction("delete", gettext("delete"), "javascript: remove_img(".$address_info["id"].");");
					} else {
