			...
			if ($show == 1) {
				$table->addTableRow(array("id"=>"selectcheck", "style" => "display: none;"));
					...
					$table->addTableData("", "data");
						...
						$table->addTag("br");
						$table->addCode(gettext("enter values for checkbox/selectbox")."<br>".gettext("seperated by newlines"));
					$table->endTableData();
				$table->endTableRow();
		...
		$venster->addVensterData();
			...
			$table->endTableRow();
				...
				$table->addTableData("", "data");
					...
					/* define the fields and mappings for the view */
					$view->addMapping(gettext("Global project templates"), "%%complex_link");
					/* specify our complex mappings */
