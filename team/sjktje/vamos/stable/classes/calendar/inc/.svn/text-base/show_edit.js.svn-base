...
var calendar_check = Array('appointmentid','appointmentfrom_day','appointmentfrom_month','appointmentfrom_year','appointmentfrom_hour', 'appointmentfrom_min','appointmentto_hour', 'appointmentto_minute', 'appointmentuser', 'appointmentis_event');
