<?php
	...
	if ($newsletter["count"] > 0) {
		...
		$table->addTableRow();
			$table->addTableData("", "header");
				$table->addCode( gettext("total receipients") );
			$table->endTableData();
			$table->addTableData("", "data");
		...
		$table->addTableRow();
			$table->addTableData("", "header");
				$table->addCode( gettext("newsletter receipients") );
			$table->endTableData();
			$table->addTableData("", "data");
	...
	if (!$mdata["is_text"]) {
		$table->addTableRow("", 1);
			...
			$table->addTableData(array("colspan"=>2), "data");
				...
				$table_template->addTableRow();
					$table_template->addTableData();
						$table_template->addCode( gettext("template font").": " );
					$table_template->endTableData();
					$table_template->addTableData();
	...
	$table->addTableRow();
		...
		$table->endTableData();
		$table->addTableData("", "data");
			$table->insertAction("back", gettext("back"), "javascript: history_goback();");
			$table->addSpace();
