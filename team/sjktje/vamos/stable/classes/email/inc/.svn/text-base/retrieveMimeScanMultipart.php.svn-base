<?php
	...
	foreach ($parts as $obj) {
		...
		if ($obj->type == 1) {
			...
			$div  = "<font size=2><div style='font: 10pt arial'>----- ".gettext("Original message")." -----";
			$div .= "<div style='background: #e4e4e4; font-color: black'><b>".gettext("from").":</b> <a href='mailto:".$from_email."'>".$from."</a></div>";
