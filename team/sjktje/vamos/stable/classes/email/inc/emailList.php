<?php
	...
	$formdata = array(
		...
		"mod"                        => "email",
		"sort"                       => $_REQUEST["sort"],
		"short_view"                 => $_REQUEST["short_view"]
	);
	...
	$table->addTableRow();
		...
		$table->addTableData( array("align"=>"right") );
			...
			$sel = array(
				...
				"set('action', 'signatures'); submitform();" => "+ ".gettext("email signatures"),
				...
				"document.location.href='?mod=newsletter';" => "+ ".gettext("newsletter")
			);
	...
	$view->defineComplexMapping("complex_flags", array(
		array(
			...
			"link" => array("?mod=email&action=$_action&sort=".$_REQUEST["sort"]."&id=", "%item")
		),
		array(
			"type"  => "action",
			"src"   => "mail_headers",
			...
			"link" => array("?mod=email&action=$_action&sort=".$_REQUEST["sort"]."&id=", "%id")
		),
		array(
			"type"  => "action",
			"src"   => "attachment",
