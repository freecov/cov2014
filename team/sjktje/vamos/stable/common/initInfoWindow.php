...
<script>
	...
	var infotekst = '<a alt=\"<?=gettext("close")?>\" title=\"<?=gettext("close")?>\" href=\"javascript:wisInfo(this)\"><img src=\"<?=$parent?>img/infowin_close.gif\" border=0></a>&nbsp;&nbsp;<b><?=gettext("Information window: ")?></b>&nbsp;<br>(<span id=\"autocloseix\"><?=$autoCloseMsg1?></span>)<br><br>';
</script>
<?
