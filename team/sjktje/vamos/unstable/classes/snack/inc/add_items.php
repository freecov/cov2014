...
$venster->addVensterData();
	...
	$table->addTableRow();
		$table->insertTableHeader(gettext("add new snack items to the database"), array("colspan" => "2"));
	$table->endTableRow();

	$table->addTableRow();
		$table->addTableData();
          $table->insertTableData(gettext("new snack item"));
		$table->endTableData();
		$table->addTableData();
	...
	$table->addTableRow();
			...
			$table->addSpace(2);
			$table->insertAction("mail_send", gettext("send"), "javascript: save_add_items();");
		$table->endTableData();
	$table->endTableRow();
	$table->endTable();
