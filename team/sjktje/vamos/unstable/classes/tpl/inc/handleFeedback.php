 ...
 */
	...
	$output->addTag("br");
	$output->addCode("<a name='pagelist'></a>");
	$output->addTag("hr");
	$output->insertAction("toggle", "", "");
	$output->addSpace();
	$output->insertTag("b", gettext("Feedback on this page or article").": ");
	$output->addTag("br");
	$output->addTag("br");
	...
	if (!$items["count"]) {
		...
		$tbl->addTableRow();
			$tbl->addTableData(array("class" => "list_record"));
				$tbl->addCode(gettext("This article has no feedback yet"));
			$tbl->endTableData();
		$tbl->endTableRow();
	}
	...
	$output->addSpace();
	$output->insertTag("b", gettext("Give feedback").":");
	$output->addTag("br");
	$output->addTag("br");
	...
	$output->addCode(gettext("To give feedback on this article").", ");
