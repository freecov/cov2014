 ...
 */
function getTeraWurflDatabaseConnnector(){return new TeraWurflDatabase_MSSQL2005();}
/**
...
(
	...
	private function createGenericCacheTable($tablename){
		$createtable = "CREATE TABLE [dbo].[{$tablename}](
...
END";
	...
	private function SQLEscapeForLike($value){
