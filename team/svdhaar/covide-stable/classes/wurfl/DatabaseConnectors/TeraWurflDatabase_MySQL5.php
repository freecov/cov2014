 ...
 */
function getTeraWurflDatabaseConnnector(){return new TeraWurflDatabase_MySQL5();}
/**
...
END";
		...
		return ($this->dbcon->query($TeraWurfl_RIS));
	}
	/**
