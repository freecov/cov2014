...
Class Desktop {
	...
	public function __construct() {
		...
		switch ($_REQUEST["action"]) {
			...
			case "saveLayout" :
				$desktop_data = new Desktop_data();
				$desktop_data->saveLayout($_REQUEST);
				break;
			case "showaddblock" :
				$desktop_output = new Desktop_output();
				$desktop_output->showAddBlock();
				break;
			case "saveaddblock" :
				$desktop_data = new Desktop_data();
				$desktop_data->saveAddBlock($_REQUEST);
				break;
			case "loadtwittercontent" :
				$desktop_output = new Desktop_output();
				$desktop_output->showTwitterContent();
				break;
			case "header_alerts" :
				$desktop_output = new Desktop_output();
				$desktop_output->header_alerts();
				break;
			case "showlogo" :
				$desktop_output = new Desktop_output();
				$desktop_output->showlogo();
				break;
