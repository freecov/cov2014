		...
		public function edit_multi_todo() {
			...
			$output->layout_page("", 1);
				...
				$venster = new Layout_venster(array(
					"title"    => gettext("TO-DO today"),
					"subtitle" => gettext("change group")
				));
				$venster->addVensterData();
					...
					$table->addTableRow();
						...
						$table->addTableData("", "data");
							...
							$table->addCode( $calendar->show_calendar("document.getElementById('todostart_day')", "document.getElementById('todostart_month')", "document.getElementById('todostart_year')" ));
						$table->endTableData();
					$table->endTableRow();
					$table->addTableRow();
						...
						$table->addTableData("", "data");
							...
							$table->addCode( $calendar->show_calendar("document.getElementById('todoend_day')", "document.getElementById('todoend_month')", "document.getElementById('todoend_year')" ));
						$table->endTableData();
					$table->endTableRow();
					$table->addTableRow();
						$table->addTableData(array("colspan" => 2), "header");
							$table->insertAction("cancel", gettext("back"), "javascript: ignore();");
							$table->insertAction("save", gettext("save"), "javascript: save();");
						$table->endTableData();
					$table->endTableRow();
					$table->endTable();
