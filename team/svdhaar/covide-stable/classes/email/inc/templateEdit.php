 ...
 */
	...
	$tbl->insertTableData("", "", "header");
		$tbl->addTableData("", "data");
			$tbl->addCode(gettext("Three minimal requirements are '{{tpl_cmnt}}' for the commencement in newsletters, '{{tpl_body}}' for the text you type in the Covide mail composer and '{{tpl_unsubscribe}}' for unsubscription link in case of newsletters."));
		$tbl->endTableData();
	$tbl->endTableRow();
	$tbl->addTableRow();
