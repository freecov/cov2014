...
var buttonName = new Array("bold","italic","underline","strikethrough","separator","cut","copy","paste","separator","insertunorderedlist","insertorderedlist","separator","link","separator","specialchar","separator","forecolor","backcolor","separator","htmlmode","separator","undo","redo");
var buttonName2 = new Array("bold","italic","underline","strikethrough","separator","cut","copy","paste","separator","insertunorderedlist","insertorderedlist","separator","link","separator","specialchar","separator","forecolor","backcolor","separator","htmlmode","separator","removeformat","separator","undo","redo");
...
function make_wyzz(textareaID) {
	if (make_wyzz.arguments.length == 3) {
		wyzzW = make_wyzz.arguments[1];
		wyzzH = make_wyzz.arguments[2];
	}
	// Hide the textarea
	...
	for (clr in buttonColors) {
		toolbar2 += '<a href="#" title="#' + buttonColors[clr] + '" alt="#' + buttonColors[clr] + '" "class="colorButton" onClick="formatTextColor(\'' + buttonColors[clr] + '\',\'' + n + '\'); return false;" style="background: #' + buttonColors[clr] + '">&nbsp;</a>';
		swatchcount++;
		if(swatchcount%18==0) {
			toolbar2 += '<br>';
		}
	...
	for (clr in buttonColors) {
		toolbar2 += '<a href="#" title="#' + buttonColors[clr] + '" alt="#' + buttonColors[clr] + '" class="colorButton" onClick="formatBackColor(\'' + buttonColors[clr] + '\',\'' + n + '\'); return false;" style="background: #' + buttonColors[clr] + '">&nbsp;</a>';
		swatchcount++;
		if(swatchcount%18==0) {
			toolbar2 += '<br>';
		}
	...
	for (fnt in myFonts) {
		toolbar2 += '<a href="#" class="fontSelect" onClick="formatFontName(\'' + myFonts[fnt] + '\',\'' + n + '\'); return false;" style="font-size:14px;padding: 0px 0px 0px 30px;font-family:' + myFonts[fnt] +'">' + myFonts[fnt] +'</a>';
		toolbar2 += '<br>';
	}
	...
	for (chr in specialChars) {
		toolbar2 += '<td><a href="#" onClick="formatSpecialChar(\'' + specialChars[chr] + '\',\'' + n + '\'); return false;">' + specialChars[chr] + '</a>&nbsp;</td>';
		charcount++;
		if(charcount%10==0) {
			toolbar2 += '</tr><tr>';
		}
	...
	for (hdr in Headers) {
		toolbar2 += '<a href="#" class="headerSelect" onClick="formatHeader(\'' + Headers[hdr] + '\',\'' + n + '\'); return false;" style="font-size:14px;padding: 0px 0px 0px 30px;font-family:arial">' + Headers[hdr] +'</a>';
		toolbar2 += '<br>';
	}
