...
function cmsCheckShopOptions() {
	if (document.getElementById('cmsisShop')) {
...
function cmsCheckShopPrice() {
	if (document.getElementById('cmsshopPrice')) {
...
document.getElementById('cmssearch_override').onclick = function() {
	cmsCheckSearchOptions();
}
if (document.getElementById('cmsshopPrice')) {
	document.getElementById('cmsshopPrice').onclick = function() {
		cmsCheckShopPrice();
	}
}
if (document.getElementById('cmsisShop')) {
	document.getElementById('cmsisShop').onclick = function() {
		cmsCheckShopOptions();
	}
}
