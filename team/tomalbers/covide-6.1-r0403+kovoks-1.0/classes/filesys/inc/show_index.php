...
$venster = new Layout_venster(array(
	...
	"subtitle" => $fsdata->getFoldernameById($id, 1)
));
$venster->addMenuItem(gettext("bestandsbeheer"), "./?mod=filesys");
$venster->addMenuItem(gettext("zoeken"), "./?mod=filesys&action=search");
