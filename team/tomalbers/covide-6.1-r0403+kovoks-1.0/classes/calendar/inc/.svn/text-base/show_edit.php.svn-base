...
$venster->addVensterData();
	...
	$table->addTableRow();
		...
		$table->addTableData("", "data");
			$table->addSelectField("appointment[group_id]", $groups, $appointment["group_id"]);
		$table->endTableData();
	$table->endTableRow();
	$table->addTableRow();
		...
		$table->addTableData("", "data");
			...
			$table->addHiddenField("appointment[user_id]", $appointment["group_id"]);
			$useroutput = new User_output();
			$table->addCode( $useroutput->user_selection("appointmentuser_id", $appointment["group_id"], 1) );
		$table->endTableData();
	$table->endTableRow();
	$table->addTableRow();
