...
//
// $Id: spell-check-ui.js,v 1.1.1.1 2006/05/10 06:49:21 stephan Exp $
...
function saveClicked() {
  ...
  if(to_p_dict.length || to_r_list.length && editor.config.SpellChecker.backend == 'php')
  {
    ...
    // var win = window;
    window.opener.HTMLArea._postback('spell-check-savedicts.php', data);
    window.close();
  }
  else
  {
...
function initDocument() {
  ...
  if(typeof editor.config.SpellChecker.defaultDictionary != "undefined"
    ...
    dict.value = "nl"; //editor.config.SpellChecker.defaultDictionary;
  } else {
    dict.value = "nl";
  }
  if(editor.config.SpellChecker.backend == 'php')
  {
    ...
    field.form.action = 'spell-check-logic.php';
  }
