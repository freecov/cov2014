...
$venster->addVensterData();
	...
	$table->addTableRow();
		$table->addTableData(array("colspan"=>2));
			$table->insertAction("print", gettext("printen"), "javascript: popup('index.php?mod=calendar&action=print_main&day=$day&month=$month&year=$year&extrauser=$rcpt', 'printmain', 300, 300, 1);");
		$table->endTableData();
	$table->endTableRow();
	$table->endTable();
