<?php
	...
	if ($id == "__search") {
		...
		echo sprintf("De opgevraagde pagina <b>".stripslashes($_REQUEST["page"])."</b> kon niet worden gevonden. Er zijn %d vergelijkbare pagina's gevonden:<br><br>", $count);
	}
