<?php
	...
	foreach ($hx as $v) {
		if (preg_match("/^X-Priority:(.*)/si",$v)) {
			...
			$v = explode(" ",$v);
			switch ($v[0]) {
				case "1":		$primg = "prior_up.gif";     $prior = "1 - ".gettext("Hoogste");           break;
				case "2":		$primg = "prior_up.gif";     $prior = "2 - ".gettext("Hoger dan normaal"); break;
				case "3":		$primg = "prior_normal.gif"; $prior = "3 - ".gettext("Middelmatig");       break;
				case "4":		$primg = "prior_down.gif";   $prior = "4 - ".gettext("Lager dan normaal"); break;
				case "5":		$primg = "prior_down.gif";   $prior = "5 - ".gettext("Laagst");            break;
			}
		}
