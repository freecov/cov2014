		...
		if ($_REQUEST["ref_type"]) {
			...
			if (is_numeric($_REQUEST["from"])) {
				...
				if ($data["is_text"]) {
					...
					$prefix.= "  </td>\n";
					$prefix.= " </tr><tr>\n";
					$prefix.= "  <td valign='top'>".gettext("van").": </td><td>".$mdata[0]["sender_emailaddress_h"]."</td>\n";
					$prefix.= " </tr><tr>\n";
					...
					$prefix.= "  <td class='cell1'>".gettext("van").": </td><td class='cell2'>".$mdata[0]["sender_emailaddress_h"]."</td>\n";
					$prefix.= " </tr><tr class='head2'>\n";
