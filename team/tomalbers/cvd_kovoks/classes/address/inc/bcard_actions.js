...
function selectRel(address_id, relname, classname) {
        var i1=classname;
        var i2='human'+classname;

	el_address = document.getElementById( i1 );
	el_span    = document.getElementById( i2 );
	...
	if (found==0) {
		...
		list = list.concat("<a href=\"javascript: removeRel('"+address_id+"', 'bcardaddress_id', 'human",classname,"');\">", relname, "</a>");
	}
