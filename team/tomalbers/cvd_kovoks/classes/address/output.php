...
Class Address_output {
	 ...
	 */
	public function show_edit($id=0, $type="relations", $sub="kantoor") {
	 ...
	 */
	public function edit_bcard($id, $address_id=0) {
	...
	/* show_FinancialCard {{{ */
	/**
	 * show all financial info 
	 */
	public function show_FinancialCard( $cardid ) {
		require(self::include_dir."showFinancialCard.php");
	}

	/* show_RelationsCard {{{ */
	/**
	 * show the relation between customers and suppliers  
	 */
	public function show_RelationsCard( $cardid ) {
		require(self::include_dir."showRelationsCard.php");
	}
	...
	/* edit_FinancialCard {{{ */
	/**
	 * edit all financial info of a relation 
	 */
	public function edit_FinancialCard( $cardid ) {
		require(self::include_dir."editFinancialCard.php");
	}
	/* }}} */

	/* edit_RelationsCard {{{ */
	/**
	 * edit relations info of a relation 
	 */
	public function edit_RelationsCard( $cardid ) {
		require(self::include_dir."editRelationsCard.php");
	}
	/* }}} */
	 ...
	 * edit all financial info of a relation 
	 */
	public function edit_FinancialBank( $bankid ) {
		require(self::include_dir."editFinancialBank.php");
	}
	/* }}} */
	...
	/* pick_bank {{{ */
	/**
	 * Show form to fetch the right bank account 
	 */
        public function pick_bank() {
                require(self::include_dir."pick_bank.php");
        }
	/* }}} */
  ...
  /* }}} */
	...
	private function generateCSVRecord($data) {
		foreach ($data as $k=>$v) {
