...
Class Product_output {
	...
	public function showSummary($productid) {
		$summary = yes;
		require(self::include_dir."showProduct.php");
	}
	...
	{
		require(self::include_dir."show_prices.php");
	}
        
	/**
	 * Show edit screen for a price 
	 *
	 * @param int The price agreement to edit
	 */
	public function editPrice($id=0) 
        {
		require(self::include_dir."editPrice.php");
	}
	...
	public function showOffer($offerid=0) 
	{
        ...
        /**
         * show an offer summary
         */
	public function showOfferSummary($customerid, $supplierid, $productid) 
	{
		require(self::include_dir."showOfferSummary.php");
	}
