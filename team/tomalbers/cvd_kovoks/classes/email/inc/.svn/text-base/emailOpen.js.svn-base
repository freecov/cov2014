...
function upd_description_text() {
	if (document.getElementById('description_notify').innerHTML != '<b>- '+gettext("niet opgeslagen")+' -</b>')
		document.getElementById('description_notify').innerHTML = '<b>- '+gettext("niet opgeslagen")+' -</b>';
}
...
function attachment(id, subaction) {
	...
	switch (subaction) {
		...
		case 'delete':
			...
			if (confirm(gettext("Weet u zeker dat u dit attachment wilt verwijderen?"))==true) {
