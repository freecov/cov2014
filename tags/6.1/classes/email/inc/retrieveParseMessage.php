<?php
	...
	$data["body"]      = $this->get_part($this->mbox, $imap_id, "TEXT/PLAIN");
	$data["body_html"] = $this->get_part($this->mbox, $imap_id, "TEXT/HTML");
	...
	$header = addslashes(imap_fetchheader($this->mbox, $imap_id));
	$data["header"] =& $header;
