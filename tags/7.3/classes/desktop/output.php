	...
	public function show_desktop() {
		...
		if ($userinfo["rssnews"]) {
			...
			if ($userinfo["xs_usermanage"])
				$venster->insertAction("edit", gettext("change:"), "index.php?mod=rss&action=listFeeds");
			$venster->addTag("br");
