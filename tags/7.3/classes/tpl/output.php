...
Class Tpl_output {
	...
	public function start_html($header=0, $textmode=0) {
		...
		$output->start_javascript();
			$output->addCode(sprintf(
				"document.write(loadXMLContent('%s%s/abbreviations.js'));",
				$this->protocol, $_SERVER["HTTP_HOST"]));
	...
	public function getBanners($num) {
		/* nothing yet */
	}
	public function displayBanner($banner_id) {
		/* nothing yet */
	}
