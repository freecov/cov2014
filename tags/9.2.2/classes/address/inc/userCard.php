...
$addressinfo[0] = $address_data->getAddressByID($address_id, "bcards");
...
$venster->addVensterData();
	...
	/* specify layout */
	$view->addMapping(gettext("name"), array("%givenname", " ", "%infix", " ", "%surname"));
	$view->addMapping(gettext("picture"), "%photo");
	$view->addMapping(gettext("contact"), "%tav");
	$view->addMapping(gettext("business address"), "%business_address");
	$view->addMapping(gettext("business zip code"), "%business_zipcode");
	$view->addMapping(gettext("business city"), "%business_city");
	$view->addMapping(gettext("business email"), "%%business_email");
	$view->addMapping(gettext("business telephone nr"), "%business_phone_nr_link", array("allow_html" => 1));
	$view->addMapping(gettext("personal address"), "%personal_address");
	$view->addMapping(gettext("personal zip code"), "%personal_zipcode");
	$view->addMapping(gettext("personal city"), "%personal_city");
	$view->addMapping(gettext("personal email"), "%personal_email");
	$view->addMapping(gettext("personal telephone nr"), "%personal_phone_nr_link", array("allow_html" => 1));
	$view->addMapping(gettext("fax nr"), "%fax_nr");
	$view->addMapping(gettext("website"), "%%website");
	$view->defineComplexMapping("business_email", array(
		array(
			"type"    => "link",
			"text"    => "%business_email",
	...
	$view->defineComplexMapping("personal_email", array(
		array(
			"type"    => "link",
			"text"    => "%personal_email",
