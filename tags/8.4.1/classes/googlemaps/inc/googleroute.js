...
function onGDirectionsLoad(){ 
	if (opener.document.getElementById("appointmentkilometers")) {
		var e = opener.document.getElementById("appointmentkilometers");
		e.value = Math.round((gdir.getDistance().meters/1000));
	}
	if (opener.document.getElementById("appointmentlocation")) {
		var e = opener.document.getElementById("appointmentlocation");
		e.value = toAddress;
	}
}
