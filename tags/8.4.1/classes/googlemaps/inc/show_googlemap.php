...
if ($id) {
	...
	foreach ($sanitized_ids as $id) {
		...
		$location = $data[0]["business_address"].', '.$data[0]["business_city"].', '.$data[0]["business_country"];
		foreach ($data as $bc) {
...
$venster->addVensterData();
	...
	$venster->addCode( $googlemaps->generate_map($location, array("style"=>"width: 500px; height:500px")) );
