...
function selection_update_parent(id, ids, str) {
	...
	/* set description */
	opener.document.getElementById('classifications_name_'+id).innerHTML = str;
}
...
function show_create_classification() {
	if (document.getElementById('newclarow')) {
		document.getElementById('newclarow').style.display='';
		document.getElementById('newclarowtext').style.display='none';
	}
}
