...
Class Mortgage_output {
	...
	public function mortgageEdit($options = array()) {
		...
		$tbl->addTableRow();
			$tbl->addTableData("", "header");
				$tbl->addCode(gettext("type"));
			$tbl->endTableData();
			$tbl->addTableData("", "data");
				$available_types = array(
					0 => gettext("mortgage"),
					1 => gettext("lifeinsurance")
				);
		...
		$tbl->addTableRow();
			$tbl->addTableData("", "header");
				$tbl->addCode(gettext("insurance company"));
			$tbl->endTableData();
			$tbl->addTableData("", "data");
		...
		$tbl->addTableRow();
			$tbl->addTableData("", "header");
				$tbl->addCode(gettext("ammount in &euro;"));
			$tbl->endTableData();
			$tbl->addTableData("", "data");
		...
		$tbl->addTableRow();
			$tbl->addTableData("", "header");
				$tbl->addCode(gettext("yearly fee in &euro;"));
			$tbl->endTableData();
			$tbl->addTableData("", "data");
		...
		$tbl->addTableRow();
			$tbl->addTableData(array("colspan"=>2), "header");
				...
				$tbl->addSpace(2);
				$tbl->insertAction("save", gettext("save"), "javascript: mortgage_save();");
			$tbl->endTableData();
		$tbl->endTableRow();
	...
	public function generate_list() {
		...
		$output = new Layout_output();
		$output->layout_page(gettext("mortgage")." ".gettext("overview"));
		...
		/* menu items */
		$venster->addMenuItem(gettext("new"), "javascript: popup('?mod=mortgage&action=edit');");
		...
		$tbl->addTableRow();
			$tbl->addTableData();
				...
				$hdr->addTableData(array("style" => "vertical-align: bottom;"));
					/* active */
					$hdr->addCode(gettext("show inactive mortgage items").": ");
				$hdr->endTableData();
				$hdr->addTableData(array("style" => "vertical-align: bottom;"));
		...
		$view->addMapping(gettext("yearly fee"), "%year_payment_h", "right");
		$view->addMapping(gettext("commission"), "%provision_h", "right");
		...
		$view->defineSort(gettext("type"), "type");
		...
		$tbl = new Layout_table();
		$tbl->addTableRow();
			$tbl->insertTableData(gettext("total ammount").":", "", "header");
			...
			$tbl->insertTableData(gettext("total commission").":", "", "header");
