 ...
 */
	...
	$view->addMapping(gettext("status"), array("<span id='h_isnew'>", "%h_isnew", "<span>"), "", "list_hidden");
	/*
	...
	$table_layout->addTableRow();
		...
		$table_layout->addTableData( array("valign"=>"top") );
			...
			$table_options->addTableRow();
				$table_options->insertTableData(gettext("actions").": ", "", "header");
				$table_options->addTableData(array("align"=>"right"), "data");
					$actions_sel = array(
						"void(0);" => " - ".gettext("more actions")." - ",
						"javascript: mail_action('new')" => gettext("new"),
						"javascript: mail_action('reply')" => gettext("reply"),
						"javascript: mail_action('reply_all')" => gettext("reply all"),
						"javascript: mail_action('forward')" => gettext("forward"),
						"javascript: mail_action('resend')" => gettext("resend"),
						"javascript: mail_action('toggle_state')" => gettext("toggle readstatus"),
						"javascript: mail_action('support');" => gettext("new support"),
						"javascript: mail_action('delete')" => gettext("delete"),
						"javascript: mail_action('print')" => gettext("print"),
						"javascript: mail_action('info');" => gettext("header information"),
						"javascript: show_extra_fields();" => gettext("show extra fields"),
					);
					if (!$mdata["is_text"]) {
						if ($viewmode == "html") {
					...
					$actions_sel["javascript: history_goback()"] = gettext("back");
					$table_options->addSelectField("email[actions]", $actions_sel);
			...
			$table_options->addTableRow(array("id" => "mailoptions_privateaddress", "style" => "display: none;"));
			...
			$table_options->addTableRow(array("id" => "mailoptions_private", "style" => "display: none;"));
			...
			$table_options->addTableRow();
			$table_options->addTableRow(array("id" => "mailoptions_users", "style" => "display: none;"));
	...
	$table_layout->addTableRow(array("id" => "mailoptions_description", "style" => "display: none;"));
