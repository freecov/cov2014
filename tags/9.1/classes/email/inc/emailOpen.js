...
function show_extra_fields() {
	var desc    = document.getElementById('mailoptions_description');
	var users   = document.getElementById('mailoptions_users');
	var private_opt   = document.getElementById('mailoptions_private');
	var privateaddress   = document.getElementById('mailoptions_privateaddress');
	desc.style.display='';
	users.style.display='';
	private_opt.style.display='';
	privateaddress.style.display='';
}
