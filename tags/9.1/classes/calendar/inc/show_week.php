<?php
	...
	$calendar_data = new Calendar_data();
		...
		$table->addTableRow();
			$table->addTableData();
				if (!$print) {
					$table->insertAction("print", gettext("print"), "javascript: popup('index.php?mod=calendar&action=print_week&userid=$useridtolookup&day=$day&month=$month&year=$year', 'printweek', 300, 300, 1);");
				}
