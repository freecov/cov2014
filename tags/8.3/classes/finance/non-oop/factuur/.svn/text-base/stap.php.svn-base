...
<?php pageNav(); ?>
	...
	<table border="0"><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>
		...
		<tr><td align="right" colspan="15" height="1"><table border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td width="90%">&nbsp;</td><td width="1"></td><td width="1"><span class="kolom">&nbsp;</span></td><td width="1"><a href="Javascript: window.close();"><img src="../img/knop_ok.gif" border="0"></a></td></tr></table></td></tr>
		<tr><td>
...
<?php
	switch($nrstap){
		case 6: ?>
			<script language="Javascript">
				function naarRechts(){
					if(document.velden.van.value!=""){
						document.location.href="<?php echo $GLOBALS["finance"]->include_dir_factuur ?>/stapproduct.php?nrstap=<?php echo $nrstap ?>&aktie=toevoegen&link_id="+opener.document.velden.producten_id.value+"&producten_id="+document.velden.van.value;
					}else{
			...
			<script language="Javascript">
				opener.document.velden.producten_id.value=<?php echo $producten_id ?>;
			</script>
