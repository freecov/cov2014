...
$venster->addVensterData();
	...
	$tbl->addTableData();
	$tbl->endTableData();
		$tbl->insertAction("new", gettext("new"), "javascript: edit_title(0, 2);");
	$tbl->endTableRow();
	$tbl->endTable();
...
$venster->addVensterData();
	...
	$tbl->addTableData();
	$tbl->endTableData();
		$tbl->insertAction("new", gettext("new"), "javascript: edit_title(0, 1);");
	$tbl->endTableRow();
	$tbl->endTable();
...
$venster->addVensterData();
	...
	$tbl->addTableData();
	$tbl->endTableData();
		$tbl->insertAction("new", gettext("new"), "javascript: edit_title(0, 3);");
	$tbl->endTableRow();
	$tbl->endTable();
...
$venster->addVensterData();
	...
	$tbl->addTableData();
	$tbl->endTableData();
		$tbl->insertAction("new", gettext("new"), "javascript: edit_title(0, 4);");
	$tbl->endTableRow();
	$tbl->endTable();
