...
/*
 * $Id: vbook.php,v 1.24 2004/12/05 12:11:53 fghellw Exp $
 *
 * Project:
...
function print_vcard_address_book($file)
{
    $style = "classes/email/inc/vcard_style.css";

    echo "<link href='$style' type='text/css' rel='stylesheet'>\n";

    echo "</head>\n<body>\n";
    echo "<h1>VCard ".gettext("contact information")."</h1>\n";
