...
if ($addresstype == "users" || $addresstype == "private" || $addresstype == "overig") {
	...
	$query_zoek = "SELECT address_businesscards.multirel, address_businesscards.id,address_businesscards.alternative_name,address_businesscards.surname,address_businesscards.infix,address_businesscards.givenname,address_businesscards.surname,address_businesscards.business_mobile_nr AS mobile_nr,address_businesscards.business_phone_nr AS phone_nr,address_businesscards.business_email AS email, address_businesscards.personal_email AS personal_email, address_businesscards.address_id as address_id, address_businesscards.classification as classification, address.companyname as companyname FROM address_businesscards $bjoin WHERE ($sq) ";
