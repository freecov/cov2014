...
class Layout_output {
	...
	public function css($theme_overwrite=0) {
		...
		if (file_exists("themes/".$theme."/covide_print.css")) {
			$file = $this->external_file_cache_handler("themes/".$theme."/covide_print.css");
			$this->addTag("link", array(
				"rel"   => "stylesheet",
				"type"  => "text/css",
				"href"  => $file,
			...
			$this->addCode("<!-- themes/".$theme."/covide_print.css -->");
			$this->addCode("\n");
		}
