	...
	public function listFeeds() {
		...
		$output->layout_page();
			...
			$frame->addVensterData();
				...
				$view->addMapping(gettext("category"), "%category");
	...
	public function editFeed($feedid=0) {
		...
		$output->layout_page("", 1);
			...
			$frame->addVensterData();
				...
				$table->endTableRow();
				$table->addTableRow();
					$table->insertTableData(gettext("category"), "", "header");
					$table->addTableData("", "data");
						$table->addTextField("rss[category]", $feed_info["category"], array("style" => "width: 400px;"));
					$table->endTableData();
				$table->endTableRow();
				$table->addTableRow();
