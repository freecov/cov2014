...
<!-- Info       : info@covide.nl -->\n\n");
	...
	$output->addCode(sprintf(
		"<link rel='stylesheet' type='text/css' href='/classes/tpl/inc/site.css?m=%d'>",
		filemtime("classes/tpl/inc/site.css")
	));
	if (!$this->textmode) {
		$output->addCode("\n\n");
		...
		$output->addCode(sprintf("UA_css('MSIE', '/classes/tpl/inc/site_msie.css?m=%d'); ",
			filemtime("classes/tpl/inc/site_msie.css")));
		$output->addCode(sprintf("UA_css('Gecko', '/classes/tpl/inc/site_gecko.css?m=%d'); ",
			filemtime("classes/tpl/inc/site_gecko.css")));
		$output->addCode(sprintf("UA_css('Opera', '/classes/tpl/inc/site_opera.css?m=%d'); ",
			filemtime("classes/tpl/inc/site_msie.css")));
