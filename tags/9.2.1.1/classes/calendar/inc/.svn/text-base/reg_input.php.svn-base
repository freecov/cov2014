	...
	$venster->addVensterData();
		$venster->addTag("ul", array("class" => "bcard_tab_ul", "style" => "list-style-type: none;"));
			$venster->addTag("li", array("id" => "bcard_li_relation", "class" => "bcard_tab_li selected"));
				$venster->insertLink(gettext("hour registration"), array("href" => sprintf("?mod=calendar&action=reg_input&id=0&timestamp=%d&project_id=%d&address_id=%d", mktime(), $calendaritem["project_id"], $calendaritem["user_id"])));
			$venster->endTag("li");
