	...
	case "bcards" :
		...
		if (is_array($field_sort)) {
			foreach ($field_sort as $field=>$sort) {
				switch ($field) {
					case "name": $view->addMapping(gettext("relation"), "%%complex_bcardsname"); break;
					...
					case "companies": $view->addMapping(gettext("companies"), "%%complex_companyname"); break;
			...
			$view->addMapping(gettext("relation"), "%%complex_bcardsname");
			$view->addMapping(gettext("telephone nr"), "%%phone_nr");
			$view->addMapping(gettext("mobile phone nr"), "%%mobile_nr");
