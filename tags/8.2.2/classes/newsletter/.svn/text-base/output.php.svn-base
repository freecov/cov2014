...
Class Newsletter_output {
	...
	public function selectFormat() {
		...
		$list = $address_data->getRelationsList( array("addresstype"=>$addresstype, "nolimit"=>1, "sub"=>$sub, "newsletterselection" => 1));
		$emails = array();
		$errors = array();
	...
	public function getAddresses() {
		...
		$address_data = new Address_data();
		$list = $address_data->getRelationsList( array("addresstype"=>$_REQUEST["addresstype"], "emailtype"=>$_REQUEST["emailtype"], "nolimit"=>1, "sub"=>$sub, "newsletterselection" => 1));
