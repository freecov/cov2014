			...
			case 2:
				...
				if ($output_only) {
					if ($v["value"] > 0) {
						...
						$tbl->insertAction("go_todo", gettext("plan in calendar"), "javascript: popup('index.php?mod=calendar&action=edit&id=0&user=".$_SESSION["user_id"]."&project_id=".$project_id."&datemask=".$v["value"]."', 'cal', 0, 0, 1);");
					} else {
						$tbl->addCode("--");
					}
				} else {
